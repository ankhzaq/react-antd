...
const GridStatusByObject = () => {
  ...
  const getLocalDataNoRedux = async (params: any, refGridToUpdate: any) => {
    if (!localInfoGrid.totalElements) {
      const baseUrl = endpoints.drilldown_gridStatusByObject.url;
      const filters = {};
          ...
          try {
            const dataSource = {
              ...
              getRows: function (params: any) {
                getLocalDataNoRedux(params, refGridTop);
              }
            };
...
export default GridStatusByObject;
